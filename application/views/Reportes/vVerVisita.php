...
$cadenadireccion = Get_Address_From_Google_Maps($datos->row()->latitud, $datos->row()->longitud);//$datosCliente->row()->calle." ".$datosCliente->row()->numero." ".$datosCliente->row()->colonia.", ".$datosCliente->row()->ciudad;
														...
														<div class="col-xs-12">
															...
															<div class="form-group">
																	<label class="col-sm-4 control-label no-padding-right blue" for="form-field-1"> Importe: </label>
																		<div class="col-sm-8">
																			<input type="text" id="cmbSucursal" name="cmbSucursal" class="form-control" value="<?php echo ($datos_pedido->num_rows() > 0) ? FORMATO_DINERO($datos_pedido->row()->total) : ""; ?>" readonly/>
																			</div>
																</div>
																<div class="form-group">
															...
															<div class="form-group">
																	...
																	<div class="col-sm-12 table-responsive">
																			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
																				...
																				<tbody>
																					<?php 
																					foreach ($datosPedido->result() as $kDP) {
																						?>
																						<tr>
