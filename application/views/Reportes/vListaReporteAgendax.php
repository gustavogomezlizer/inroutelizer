						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									?> -->
									<?php 	
										$dia=date('w', strtotime('2018-10-10'));
										echo $dia;
	 								?>
								</small>
							</h1>
			...
			var myTable = 
				...
				function hacerFiltrado(){
						...
						$("#lblNumVisitas").html("<?php echo $cuantasvisitas; ?>");
							...
							//alert("Hola");
							$.post("<?php echo CREPORTES('postVisitasProgramadas');?>", {usuario: elusuario, sucursal: sucursal, fechaI: $("#txtFInicio").val(), fechaF: $("#txtFFinal").val(), ruta: ruta},function(data){
											alert(data);
