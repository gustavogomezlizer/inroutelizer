											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>Usuario</th>
														<th>Ruta</th>
														<th>Efectividad (Pedidos/Visitas)</th>
														<th>Inicio</th>
														<th>Fin</th>														
														<th>Monto Pedido</th>
														<th>Sucursal</th>
			...
			var myTable = 
				...
				function hacerFiltrado(){
					       ...
					       $.post("<?php echo CREPORTES('postTotalesEfectividad');?>", {usuario: usuario, sucursal: sucursal, fechaI: $("#txtFInicio").val(), fechaF: $("#txtFFinal").val(), ruta: ruta},function(data){
					        ...
					        $.post("<?php echo CREPORTES('postTotalesPedidos');?>", {usuario: usuario, sucursal: sucursal, tipo: "TODOS", fechaI: $("#txtFInicio").val(), fechaF: $("#txtFFinal").val(), ruta: ruta},function(data){
											//alert(data);
												var losdatos=data.split("-");
													$("#lblTotPedidos").html(losdatos[1]);
						...
						if(cambio==0){
			               ...
			               if( seleccionadosRuta.includes("TODOS") ){
			                  ...
			                  {
			                    myTable.column(6).search(seleccionadosSucursal, true, false ).draw();  
			                  }
						}
						else{
							
							window.location.href = "<?php echo CREPORTES(); ?>"+"listaEfectividad"+"/"+$("#txtFInicio").val()+"/"+$("#txtFFinal").val()+"/"+seleccionadosUsuario2+"/"+seleccionadosRuta2+"/"+seleccionadosSucursal2;
						}
				}
