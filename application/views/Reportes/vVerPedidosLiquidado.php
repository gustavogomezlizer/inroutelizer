						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Reportes / Ver Pedidos Liquidado
																			...
																			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
																				...
																				<tbody>
																					...
																					foreach ($lista->result() as $kDP) {
																						...
																						$cantidad_real = $kDP->cantidad_entregado - $kDP->cantidad_rechazado;
																						$importe_real = $cantidad_real * $kDP->precio;
																						...
																						<tr>
																							...
																							<td><?php echo $kDP->clasificacionproducto; ?></td>
																							<td><?php echo $kDP->codigoproducto; ?></td>
																							<td><?php echo $kDP->producto; ?></td>
																							<td><?php echo $cantidad_real; ?></td>
																							<td><?php echo FORMATO_DINERO($kDP->precio); ?></td>
																							<td><?php echo FORMATO_DINERO($importe_real); ?></td>
