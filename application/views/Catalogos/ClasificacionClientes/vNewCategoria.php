					...
					<div class="row">
						<div class="col-xs-12">
							<div class="col-md-12 col-xs-12 col-sm-12" align="right">
								...
								<a href="<?php echo LINKPROYECTO('ClasificacionClientes') ?>" class="btn btn-danger">REGRESAR</a>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="row" align="center">
											<div class="col-xs-12">
												<h4 class="control-label green">NUEVA CLASIFICACION DE CLIENTE</h4>
											</div>
										</div>
											...
											<div class="col-xs-12">
												<div class="form-horizontal" role="form">
													...
													<div class="form-group">
														<label class="col-sm-4 control-label no-padding-right blue" for="form-field-1"> Clasificación <small>(Obligatorio)</small>: </label>
														<div class="col-sm-8">
															<input type="text" id="txtNombre" name="clasificacion" class="form-control obligatorio" value=""/>
														</div>
													</div>
...
<script>
	...
	$(".btnGuardar").click(function(event) 
	{
		...
		if(nombre=="")
		{
			dialogAvisoGlobal.show("Favor de escribir una clasificación", "alert alert-warning");
		}else{
			$.post("<?php echo LINKPROYECTO('GuardarClasificacionCliente') ?>", $("#form_savecategoria").serialize(), function(data){				
				if( parseFloat(data.trim())>0 ){
					dialogAvisoGlobal.show("Categoria guardada correctamente", "alert alert-success");
					window.location = "<?php echo LINKPROYECTO('ClasificacionClientes') ?>";
				}else{
	...
	<?php if($opcion=="editar" || $opcion=="ver") { ?>
		...
		{
			$("#txtId").val("<?php echo $clasificacion_cliente->id; ?>");
			$("#txtNombre").val("<?php echo $clasificacion_cliente->clasificacion; ?>");
			$("#checkActivo").prop("checked", "<?php echo (($clasificacion_cliente->status==1) ? true : false); ?>");
		}
	<?php } ?>
