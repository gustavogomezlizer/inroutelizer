						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row"><!--  empieza div.row de la tabla clientes -->
									<div class="col-xs-2"><label for="">Mes</label><input id="txtFInicio" type="input" class="form-control" value="<?php echo $fIni; ?>"></div>
									<div class="col-xs-2"><label for="">Año</label><input id="txtFFinal" type="date" class="form-control" value="<?php echo $fFin; ?>"></div>
										...
										<select name="cmbUsuario" id="cmbUsuario" class="selectpicker form-control" multiple="multiple" data-style="btn-white" data-live-search="false" title="(Selecciona Usuario)">
											...
											<?php 
												...
												foreach ($listaUsuarios->result() as $kU) {
													...
													?>
													<option value="<?php echo $kU->id; ?>"><?php echo $kU->nombre; ?></option>
													<?php 
									...
									<div class="col-xs-12">	<!--  empieza div.col-xs-12 de la tabla clientes -->
										...
										<div class="clearfix col-md-6">
											<div class="pull-right"><button id="btnAplicar" class="btn btn-primary">Aplicar</button><button class="btn btn-success btnActualizar">Actualizar</button><button class="btn btn-warning btnCorte">Corte</button><button class="btn btn-default btnAcumulados">Acumulados</button></div>
										</div>
