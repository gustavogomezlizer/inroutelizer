							...
							<div class="col-xs-10">
								...
								<div class="row"><!--  empieza div.row de la tabla clientes -->
									...
									<div class="space-40"></div>
										...
										<div class="col-xs-12">
									<form id="frmDatos" action="<?php echo CCONFIGURAR('saveNuevoPerfil'); ?>" method="POST">
										<div class="row">
									<div class="col-sm-12">
															...
															<div class="form-horizontal" role="form">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		<input type="text" id="txtPerfil" name="txtPerfil" class="form-control" value=""/>
																	</div>
																</div>
																<div class="form-group">
																					...
																					foreach ($submodulo->result() as $kSM) {
																						?>
																							...
																							<label  class="col-sm-offset-2 col-sm-10 no-padding-right blue">  
																								<?php 
																								//$status=GETACCESO($kMod1->controlador,$kSMenu->funcion);
																								$status=0;
																									if($status==1){
																										?>
