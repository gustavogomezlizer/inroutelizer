								...
								<div class="row"><!--  empieza div.row de la tabla clientes -->
									...
									<div class="col-sm-12">
															...
															<div class="row" align="center">
																<div class="col-xs-12">
																	<h4 class="control-label green">NUEVO PERFIL</h4>
																</div>
															</div>
															...
															<div class="form-horizontal" role="form">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		<input type="text" id="txtPerfil" name="txtPerfil" class="form-control" value="<?php echo $datosPerfil->row()->perfil; ?>" readonly/>
																	</div>
																</div>
																<div class="form-group">
																	<label class="col-sm-4 control-label no-padding-right blue" for="form-field-1" readonly> Descripcion: </label>

																	<div class="col-sm-8">
																		
																		<textarea id="txtDescripcion" name="txtDescripcion" class="form-control" readonly><?php echo $datosPerfil->row()->descripcion; ?></textarea>
																	</div>
																</div>
																<div class="form-group">
																						...
																						?>
																							...
																							<label  class="col-sm-offset-2 col-sm-10 no-padding-right blue">  
																								...
																								//$status=0;
																									if($status==1){
																										?>
																											<input id="Check<?php echo $kSM->id; ?>" name="Check<?php echo $kSM->id; ?>" class="ace" type="checkbox" checked disabled/>
																										<?php 
																									}
																									else{
																										?>
																											<input id="Check<?php echo $kSM->id; ?>" name="Check<?php echo $kSM->id; ?>" class="ace" type="checkbox" disabled/>
																										<?php 
																									}
																								 ?>
