...
<!-- <link rel="stylesheet" href="<?php echo RUTAFOLDERASSETS("leafletzoom/L.Control.ZoomBar.css"); ?>" /> -->
							...
							<div class="col-xs-12">
								...
								<div class="row"><!--  empieza div.row de la tabla clientes -->
									...
									<div class="space-40"></div>
										...
										<div class="col-xs-12">
									<form id="frmDatos" action="<?php echo CCATALOGOS('saveEditarRuta'); ?>" method="POST">
										<div class="row">
									<div class="col-sm-6">
										
															<div class="row" align="center">
																<div class="col-xs-12">
																	<h4 class="control-label green">VER RUTA</h4>
																</div>
															</div>
													...
													<div class="row">
														<div class="col-xs-12">
															<div class="form-horizontal" role="form">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		<input type="text" id="txtRuta" name="txtRuta" class="form-control" value="<?php echo $ruta; ?>"/ readonly>
																	</div>
																</div>
																<div class="form-group">
																	...
																	<label  class="col-sm-offset-4 col-sm-2 no-padding-right blue">  
																		<?php 
																			...
																			if($status==1){
																				?>
																					<input id="checkActivo" name="checkActivo" class="ace" type="checkbox" checked disabled/>
																				<?php 
																			}
																			else{
																				?>
																					<input id="checkActivo" name="checkActivo" class="ace" type="checkbox" disabled/>
																				<?php 
																			}
																		 ?>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		<textarea id="txtComentarios" name="txtComentarios" class="form-control" readonly><?php echo $descripcion; ?></textarea>
																...
																<label class="col-sm-4 control-label no-padding-right blue" for="form-field-1"> Sucursal: </label>
																	<div class="col-sm-8">
																		...
																		<select id="cmbSucursal" name="cmbSucursal" class="form-control" disabled>
																			...
																			<?php 
																				...
																				if($kSuc->id==$sucursal){
																					...
																					?>
																					<option value=<?php echo $kSuc->id; ?> selected><?php echo $kSuc->sucursal; ?></option>
																					<?php 
																					}
																					else{
																						?>
															...
															<div class="form-group">
																	...
																	<div class="col-sm-8">
																	<select multiple="" id="cmbProveedor" name="cmbProveedor" class="select2 form-control" data-placeholder="Elige opcion" disabled>
																			<?php
																			$textoProveedores="0";
																			foreach ($listaProveedores->result() as $kProv) {

																				$valProCli=$this->CatalogosModel->validarProveedorRuta($kProv->id,$id);
																				
																				if($valProCli=="SI"){
																					if($textoProveedores=="0"){
																						$textoProveedores=$kProv->id;
																					}
																					else{
																						$textoProveedores.=",".$kProv->id;
																					}
																			...
																			?>
																				<option value="<?php echo $kProv->id; ?>" selected><?php echo $kProv->nombre; ?></option>
																			<?php 
																				}
																				else{
																					?>
																	...
																	<input type="hidden" id="txtProveedor" name="txtProveedor" value="<?php echo $textoProveedores; ?>">
															...
															<div class="form-group">
																	...
																	<div class="col-sm-8">
																	<select multiple="" id="cmbZona1" name="cmbZona1" class="select2 zona1" data-placeholder="Elige opcion" disabled>
																		<?php 
																		$textoZona="0";
																		foreach ($listaZonas->result() as $kZona) {
																			$valRutZon=$this->CatalogosModel->validarZonaRuta($kZona->id,$id);
																			if($valRutZon=="SI"){
																				if($textoZona=="0"){
																					$textoZona=$kZona->id;
																				}
																				...
																				?>
																				<option value="<?php echo $kZona->id; ?>" selected><?php echo $kZona->zona; ?></option>
																			<?php 
																			}
																			else{
																				?>
																				<option value="<?php echo $kZona->id; ?>"><?php echo $kZona->zona; ?></option>
																			<?php 
																			}
																		}
																	...
																	<input type="hidden" id="txtZona" name="txtZona" value="<?php echo $textoZona; ?>">
															...
															<div class="form-group">
																<label class="col-sm-4 control-label no-padding-right blue" for="form-field-1"> Agente: </label>
																	<div class="col-sm-8">
																		...
																		<select id="cmbAgente" name="cmbAgente" class="form-control" disabled>
																			<?php 
																			foreach ($listaAgentes->result() as $kAgentes) {
																				# code...
																				if($chofer==$kAgentes->id){
																					
																					?>
																					<option value="<?php echo $kAgentes->id; ?>" selected><?php echo $kAgentes->nombre; ?></option>
																					<?php 
																				}
																				else{
																					?>
																					<option value="<?php echo $kAgentes->id; ?>"><?php echo $kAgentes->nombre; ?></option>
																					<?php 
